...
const SectionTwo = () => {
  return (
    <div className="flex flex-col mx-auto  justify-center gap-[64px] px-[24px]  sm:px-[48px] pb-[56px] max-w-[500px]  sm:w-[1280px] w-full sm:min-w-full overscroll-contain">
