const SectionFour = () => {
  return (
    <div className="w-full max-w-[500px] sm:max-w-[1280px] lg:px-[72px] xl:px-[160px] py-[96px] px-[24px] flex-col items-start justify-start inline-flex self-stretch  gap-[10px]  max-h-[1701px] xl:max-h-[726px] h-auto mx-auto overscroll-contain overflow-hidden">
      ...
      <div className="self-stretch  flex flex-col lg:flex-row  justify-start items-start sm:items-center	 gap-[96px]  sm:gap-[48px]  h-auto max-h-[1205px] xl:max-h-[630px] w-full sm:max-w-[960px] max-w-[452px] mx-auto ">
        <div className="flex flex-col justify-center items-center gap-10 flex-1   w-full max-h-[527px] max-w-[456px] md:max-w-[920] lg:max-w-[456px] h-full ">
          <div className="self-stretch justify-start text-SB_Dark_Blue text-[56px] sm:text-[64px] font-bold font-[futura-pt-bold] leading-[64px]  max-h-[107px] h-auto tracking-[-2.56px]">
            The Power of Your One Day
          </div>
          <div className="self-stretch justify-start text-SB_Dark_Blue text-md font-normal font-[`futura-pt`] text-[18px]  max-w-[456px] w-full leading-6 min-h-[84px] h-full ">
          ...
          <div className=" text-SB_Dark_Blue  font-normal font-[`futura-pt`] text-[18px] self-stretch mt-8 text-center">
            But what if your one day could build something eternal?
          </div>
          <div className="max-h-[350px] h-full max-w-[452px]  w-full ">
