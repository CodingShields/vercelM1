import burkinaImageOne from "./burkina/burkina-image-one.jpg";
import burkinaImageTwo from "./burkina/burkina-image-two.jpg";
import burkinaImageThree from "./burkina/burkina-image-three.jpg";
import congoImageOne from "./congo/congo-image-one.jpg";
import congoImageTwo from "./congo/congo-image-two.jpg";
import congoImageThree from "./congo/congo-image-three.jpg";
import cubaImageOne from "./cuba/cuba-image-one.jpg";
import cubaImageTwo from "./cuba/cuba-image-two.jpg";
import cubaImageThree from "./cuba/cuba-image-three.jpg";
import dominicanImageOne from "./dominican/dominican-image-one.jpg";
import dominicanImageTwo from "./dominican/dominican-image-two.jpg";
import dominicanImageThree from "./dominican/dominican-image-three.jpg";
import dominicanImageFour from "./dominican/dominican-image-four.jpg";
import indiaAmImageOne from "./india-ammapettai/india-am-image-one.jpg";
import indiaAmImageTwo from "./india-ammapettai/india-am-image-two.jpg";
import indiaAmImageThree from "./india-ammapettai/india-am-image-three.jpg";
import indiaGuImageOne from "./india-guwahati/india-gu-image-one.jpg";
import indiaGuImageTwo from "./india-guwahati/india-gu-image-two.jpg";
import indiaGuImageThree from "./india-guwahati/india-gu-image-three.jpg";
import kenyaDagImageOne from "./kenya-dagoretti/kenya-dag-image-one.jpg";
import kenyaDagImageTwo from "./kenya-dagoretti/kenya-dag-image-two.jpg";
import kenyaDagImageThree from "./kenya-dagoretti/kenya-dag-image-three.jpg";
import kenyaMalaaImageOne from "./kenya-malaa/kenya-malaa-image-one.jpg";
import kenyaMalaaImageTwo from "./kenya-malaa/kenya-malaa-image-two.jpg";
import kenyaMalaaImageThree from "./kenya-malaa/kenya-malaa-image-three.jpg";
import nepalImageOne from "./nepal/nepal-image-one.jpg";
import nepalImageTwo from "./nepal/nepal-image-two.jpg";
import nepalImageThree from "./nepal/nepal-image-three.jpg";
import salvadorImageOne from "./salvador/salvador-image-one.jpg";
import salvadorImageTwo from "./salvador/salvador-image-two.jpg";
import salvadorImageThree from "./salvador/salvador-image-three.jpg";
import senegalImageOne from "./senegal/senegal-image-one.jpg";
import senegalImageTwo from "./senegal/senegal-image-two.jpg";
import zimImageOne from "./zimbabwe/zim-image-one.jpg";
import zimImageTwo from "./zimbabwe/zim-image-two.jpg";
import zimImageThree from "./zimbabwe/zim-image-three.jpg";
import zimImageFour from "./zimbabwe/zim-image-four.jpg";
const locationData = [
  {
    id: 0,
