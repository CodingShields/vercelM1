...
const LocationCard = ({ open, handleClose, images, data }) => {
  ...
  console.log(data);
  return (
    <div className="fixed z-40  left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2  ">
      <div className="w-[368px] px-6 pt-3 pb-6 bg-m1-BG rounded-[20px] shadow-[0px_0px_30px_0px_rgba(0,0,0,0.15)] inline-flex flex-col justify-start items-start gap-3 bg-[#31302B] ">
