...
const LocationCard = forwardRef(({ open, handleClose, images, data }, ref) => {
  ...
  return (
    ...
    >
      <div className="w-[336px] px-6 pt-3 pb-6 bg-m1-BG rounded-[20px] shadow-[0px_0px_30px_0px_rgba(0,0,0,0.15)] inline-flex flex-col justify-start items-start gap-3 bg-[#31302B] scale-90">
        {/* Existing content */}
